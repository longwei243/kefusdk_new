 ...
 * 
 * <p>
 * To set the logger to a particular type, set the system property ("com.moor.imkf.ormlite.logger.type") contained in
 * {@link #LOG_TYPE_SYSTEM_PROPERTY} to be one of the values in LogType enum.
 * </p>
 */
public class LoggerFactory {

	public static final String LOG_TYPE_SYSTEM_PROPERTY = "com.moor.imkf.ormlite.logger.type";
	...
	public enum LogType {
		 ...
		 */
		ANDROID("android.util.Log", "com.moor.imkf.ormlite.android.AndroidLog"),
		SLF4J("org.slf4j.LoggerFactory", "com.moor.imkf.ormlite.logger.Slf4jLoggingLog"),
		COMMONS_LOGGING("org.apache.commons.logging.LogFactory", "com.moor.imkf.ormlite.logger.CommonsLoggingLog"),
		LOG4J2("org.apache.logging.log4j.LogManager", "com.moor.imkf.ormlite.logger.Log4j2Log"),
		LOG4J("org.apache.log4j.Logger", "com.moor.imkf.ormlite.logger.Log4jLog"),
