package com.moor.imkf.ormlite.android;
 ...
 * @author graywatson
 */
public class AndroidLog implements com.moor.imkf.ormlite.logger.Log {
	...
	public AndroidLog(String className) {
		...
		int maxLevel = 0;
		for (com.moor.imkf.ormlite.logger.Log.Level level : com.moor.imkf.ormlite.logger.Log.Level.values()) {
	...
	private int levelToAndroidLevel(com.moor.imkf.ormlite.logger.Log.Level level) {
		switch (level) {
			case TRACE :
				return Log.VERBOSE;
			case DEBUG :
