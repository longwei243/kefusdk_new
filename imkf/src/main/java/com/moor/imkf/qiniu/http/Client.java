...
public final class Client {
    ...
    public Client(Proxy proxy, int connectTimeout, int responseTimeout, UrlConverter converter, final DnsManager dns) {
        ...
        httpClient.networkInterceptors().add(new Interceptor() {
            @Override
            public com.moor.imkf.okhttp.Response intercept(Chain chain) throws IOException {
                Request request = chain.request();

                com.moor.imkf.okhttp.Response response = chain.proceed(request);
    ...
    private static String via(com.moor.imkf.okhttp.Response response) {
        String via;
    ...
    private static String ctype(com.moor.imkf.okhttp.Response response) {
    ...
    public void asyncSend(final Request.Builder requestBuilder, StringMap headers, final CompletionHandler completionHandler) {
        ...
        httpClient.newCall(requestBuilder.tag(tag).build()).enqueue(new Callback() {
            ...
            @Override
            public void onResponse(com.moor.imkf.okhttp.Response response) throws IOException {
                long duration = (System.currentTimeMillis() - start) / 1000;
    ...
    private void onRet(com.moor.imkf.okhttp.Response response, String ip, long duration,
