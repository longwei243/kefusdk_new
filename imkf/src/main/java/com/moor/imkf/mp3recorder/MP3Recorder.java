...
public class MP3Recorder {
	...
	public MP3Recorder(File recordFile, File PCMFile) {
		mRecordFile = recordFile;
		this.mPCMFile = PCMFile;
	}
...
//		}
		...
		// The thread will 
		mEncodeThread = new DataEncodeThread(mRecordFile, mBufferSize, mPCMFile);
		mEncodeThread.start();
		mAudioRecord.setRecordPositionUpdateListener(mEncodeThread, mEncodeThread.getHandler());
		mAudioRecord.setPositionNotificationPeriod(FRAME_COUNT);

		System.out.println("录音的采样率是："+mAudioRecord.getSampleRate());
	}
}